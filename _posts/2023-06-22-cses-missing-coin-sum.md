...
The naive approach would be trying out all the subets which is 2^n but, this would be too slow. Let’s sort the numbers first. Let’s say we have a variable x that tells us that 1 ~ x can be found and set it to 0 at first.
